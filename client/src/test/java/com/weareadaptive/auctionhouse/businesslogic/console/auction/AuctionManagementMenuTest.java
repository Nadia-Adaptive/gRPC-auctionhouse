...
import com.weareadaptive.auctionhouse.businesslogic.model.AuctionState;
...
import com.weareadaptive.auctionhouse.businesslogic.model.InstantTimeProvider;
import com.weareadaptive.auctionhouse.businesslogic.model.ModelState;
import com.weareadaptive.auctionhouse.businesslogic.model.OrganisationState;
import com.weareadaptive.auctionhouse.businesslogic.model.TimeContext;
import com.weareadaptive.auctionhouse.businesslogic.model.UserState;
...
import static com.weareadaptive.auctionhouse.businesslogic.TestData.USER1;
import static com.weareadaptive.auctionhouse.businesslogic.TestData.USER2;
import static com.weareadaptive.auctionhouse.businesslogic.TestData.USER3;
import static com.weareadaptive.auctionhouse.businesslogic.TestData.USER4;
...
public class AuctionManagementMenuTest {
    private static MenuContext createContext(final String src, final Optional<AuctionState> auctionState) {
        ...
        MenuContext context = new MenuContext(new ModelState(new UserState(), new OrganisationState(),
                ...
                new TimeContext(new InstantTimeProvider()));
